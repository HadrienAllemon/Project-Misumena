...
const Login = () => {
    ...
    const [playerRoom, setPlayerRoom] = useState<string>(room || "");
                            ...
                            <Flex alignItems={"center"} justifyContent={"flexStart"} height={"100%"} gap={"4rem"}>
                                ...
                                <FormControl>
                                    ...
                                    <Box mb={10}>
                                        ...
                                        <Input color="black" disabled={room!=undefined} value={playerRoom} onChange={(event) => setPlayerRoom(event.target.value)} id="standard-basic" variant="standard" />
                                    </Box>
